            ...
            <div>
                <Row className = "containerh">
                            ...
                            <div className={navbar ? 'searchBar':'searchBar searchbarhide'}>
                                <Form inline='true'>
                                    <Row className='form-search'>
                                        ...
                                        <div>
                                            <FormControl type="text" placeholder="What service are you looking for today?" className='mr-lg-0' />
                                        </div>
                    ...
                    <ul className='nvegation col'>
                        <li className='ll'>
                            <a href='/' className={navbar? 'linkcolor' : 'disactivecolor'}>Fiverr Business</a>
                        </li>
                        <li className='sli'>
                            <a href='/' className={navbar? 'linkcolor' : 'disactivecolor'}>Explore</a>
                        </li>
                        <li className='sli'>
                        ...
                        <li className='tli'>
                            <a href='/' className={navbar? 'linkcolor' : 'disactivecolor'}>$ USD</a>
                        </li>
                        <li className='tli'>
                            <a href='/' className={navbar? 'linkcolor' : 'disactivecolor'}>Become a Seller</a>
                        </li>
                        <li className={navbar? 'signinli linkcolor' : 'signinli disactivecolor'} onClick={handleOpen}>
                            Sign In
                        </li>
                        <li className='bli'>
                            <a href='/join' className={navbar? 'linkcolor' : 'disactivecolor'}>
