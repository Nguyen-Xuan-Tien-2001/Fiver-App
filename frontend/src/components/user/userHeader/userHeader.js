...
import Menu from '../navMenu/menu.js'
            ...
            <Row>
                <Col sm='9'>
                    <ul>
                        ...
                        <li>
                            <Link to="/user/OwnerOrder">Owner's Order</Link>
                        </li>
                        <li>
                            <Link to="/user/gigs">Gigs</Link>
                        </li>
                        <li>
                            <Link to="/user/postRequest">Post A Requests</Link>
                        </li>
                        <li>
                ...
                <Col sm='3'>
                    <ul className='user-navbar'>
                        ...
                        <li>
                            <span className='userName'>{getInforUserResponse? getInforUserResponse.first_name: ''} {getInforUserResponse? getInforUserResponse.last_name : ''}</span>
                        </li>
